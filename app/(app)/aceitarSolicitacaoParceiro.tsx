...
export default function AceitarSolicitacoesScreen() {
  ...
  const fetchMateriaisParceiro = async () => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/materiais-parceiros?id_parceiros=${user.partner_id}`);
  ...
  const fetchSolicitacoes = async () => {
    try {
      ...
      const solicitacoesResponse = await axios.get(`${API_BASE_URL}/solicitacoes?estado_solicitacao=pendente`);
